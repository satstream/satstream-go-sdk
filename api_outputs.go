...
/*
OutputsApiService Get output info by outpoint
...
func (a *OutputsApiService) GetOutputByOutpoint(ctx context.Context, outpoint string) (InlineResponse20025, *http.Response, error) {
	...
	localVarPath := a.client.cfg.BasePath + "/output/{outpoint}"
...
/*
OutputsApiService Get multiple outputs
Retrieve information about multiple UTXOs
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param body Outpoints
@return InlineResponse2002
*/
func (a *OutputsApiService) GetOutputs(ctx context.Context, body []string) (InlineResponse2002, *http.Response, error) {
	var (
