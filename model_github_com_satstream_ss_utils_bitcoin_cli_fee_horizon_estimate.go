...
type GithubComSatstreamSsUtilsBitcoinCliFeeHorizonEstimate struct {
	...
	Fail *AllOfgithubComSatstreamSsUtilsBitcoinCliFeeHorizonEstimateFail `json:"fail,omitempty"`
	// Estimate fee rate in BTC/kvB
	Feerate float64 `json:"feerate,omitempty"`
	// Information about lowest range of feerates to succeed
	Pass *AllOfgithubComSatstreamSsUtilsBitcoinCliFeeHorizonEstimatePass `json:"pass,omitempty"`
