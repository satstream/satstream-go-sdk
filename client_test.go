...
func TestUserAgentHeader(t *testing.T) {
	...
	client.Fees.List(context.Background())
	if userAgent != fmt.Sprintf("Satstream/Go %s", internal.PackageVersion) {
...
func TestContextCancel(t *testing.T) {
	...
	cancel()
	res, err := client.Fees.List(cancelCtx)
	if err == nil || res != nil {
		t.Error("Expected there to be a cancel error and for the response to be nil")
	}
}
...
func TestContextDeadline(t *testing.T) {
	...
	go func() {
		...
		res, err := client.Fees.List(deadlineCtx)
		if err == nil || res != nil {
