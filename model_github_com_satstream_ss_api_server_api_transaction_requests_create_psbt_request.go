...
type GithubComSatstreamSsApiServerApiTransactionRequestsCreatePsbtRequest struct {
	// The inputs for the transaction
	Inputs []GithubComSatstreamSsApiServerApiTransactionRequestsCreatePsbtInput `json:"inputs"`
	...
	Outputs []GithubComSatstreamSsApiServerApiTransactionRequestsCreatePsbtOutput `json:"outputs"`
