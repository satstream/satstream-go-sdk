...
/*
FeesApiService Estimate Raw Fee
...
*/
func (a *FeesApiService) EstimateRawFee(ctx context.Context, body RequestsEstimateRawFeeRequest) (InlineResponse20015, *http.Response, error) {
	var (
...
/*
FeesApiService Estimate smart fee
Estimates the approximate fee per kilobyte needed for a transaction to begin confirmation within conf_target blocks
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param body Fee estimation parameters
@return InlineResponse20016
*/
func (a *FeesApiService) EstimateSmartFee(ctx context.Context, body RequestsEstimateSmartFeeRequest) (InlineResponse20016, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
